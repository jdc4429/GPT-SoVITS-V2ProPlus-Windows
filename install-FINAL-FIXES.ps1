...
switch ($Device) {
    ...
    "CU128" {
        ...
        Invoke-Pip torch==2.9.1 torchvision==0.24.1 torchaudio==2.9.1 --index-url "https://download.pytorch.org/whl/cu128"
    }
    "CU130" {
        Write-Info "Installing PyTorch For CUDA 13.0..."
        Invoke-Pip torch==2.9.1 torchvision==0.24.1 torchaudio==2.9.1 --index-url "https://download.pytorch.org/whl/cu130"
    }
    "CPU" {
